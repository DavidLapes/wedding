    ...
    (let [datasource (:datasource datasource)
      ...
      (jdbc/with-db-connection [connection {:datasource datasource}]
        (try
          ...
          (execute-sql-file connection "scripts/drop_views.sql")
          (timbre/info "Creating views")
          (execute-sql-file connection "scripts/create_views.sql")
          (timbre/info "Dropping indexes")
          (execute-sql-file connection "scripts/drop_indexes.sql")
          (timbre/info "Creating indexes")
          (execute-sql-file connection "scripts/create_indexes.sql")
          (timbre/info "Analyzing database")
          (execute-sql-file connection "scripts/analyze.sql")
          (catch Exception ex
